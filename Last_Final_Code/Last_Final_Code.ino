...
int currentPosition; // 초기 위치 변수
const int stepsPerRevolution = 200; // 한 바퀴의 스텝 수
const int targetPosition = 200; // 목표 위치
    ...
    if (buffer[0] == 'a') {
      ...
      while(1){
       if (currentPosition < targetPosition) {
        ...
        currentPosition++;
        // delay(10); // 스텝 간의 딜레이 (필요한 경우 조정)
       }
        else {
        // 목표 위치에 도달했을 때 동작을 멈춥니다.
         motor.release();
         break;
       // 무한 루프
       }
